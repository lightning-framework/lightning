...
public class RouteMatchResult {
    private final HashMap<String, Integer> integerMatches = new LinkedHashMap<String, Integer>(); // ORDER MATTERS
    private final HashMap<String, String> stringMatches = new LinkedHashMap<String, String>(); // ORDER MATTERS
