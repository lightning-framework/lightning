...
public class ExceptionMapperTest {
  ...
  public void testExceptionMapper() {
    ...
    assertEquals("Throwable", mapper.getHandler(Error.class));
    assertEquals("Exception", mapper.getHandler(Exception.class));
    //assertEquals("Exception", mapper.getHandler(BadRequestException.class));
    assertEquals("NotFoundException", mapper.getHandler(NotFoundException.class));
